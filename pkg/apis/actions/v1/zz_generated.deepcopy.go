...
func (in *KindActionMappingSpec) DeepCopyInto(out *KindActionMappingSpec) {
	*out = *in
	...
	if in.StatusMappings != nil {
		in, out := &in.StatusMappings, &out.StatusMappings
		*out = make([]MappingConfiguration, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OwnerConfiguration) DeepCopyInto(out *OwnerConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OwnerConfiguration.
func (in *OwnerConfiguration) DeepCopy() *OwnerConfiguration {
	if in == nil {
		return nil
	}
	out := new(OwnerConfiguration)
	in.DeepCopyInto(out)
	return out
}
