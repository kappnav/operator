...
func (in *AutoCreateKindConfiguration) DeepCopyInto(out *AutoCreateKindConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoCreateKindConfiguration.
func (in *AutoCreateKindConfiguration) DeepCopy() *AutoCreateKindConfiguration {
	if in == nil {
		return nil
	}
	out := new(AutoCreateKindConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KappnavSpec) DeepCopyInto(out *KappnavSpec) {
	*out = *in
	...
	if in.AutoCreateKinds != nil {
		in, out := &in.AutoCreateKinds, &out.AutoCreateKinds
		*out = make([]AutoCreateKindConfiguration, len(*in))
		copy(*out, *in)
	}
	return
}
